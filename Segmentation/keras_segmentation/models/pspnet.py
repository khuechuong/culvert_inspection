...
################################################################################
def vgg19_pspnet(n_classes,  input_height=384, input_width=576):

    model = _pspnet(n_classes, get_vgg19_encoder,
                    input_height=input_height, input_width=input_width)
    model.model_name = "vgg19_pspnet"
    return model

def xception_pspnet(n_classes,  input_height=384, input_width=576):

    model = _pspnet(n_classes, get_Xception_encoder,
                    input_height=input_height, input_width=input_width)
    model.model_name = "xception_pspnet"
    return model

def inception_v3_pspnet(n_classes,  input_height=384, input_width=576):

    model = _pspnet(n_classes, get_InceptionV3_encoder,
                    input_height=input_height, input_width=input_width)
    model.model_name = "inception_v3_pspnet"
    return model
